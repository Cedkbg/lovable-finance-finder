        ...
        >
          <div className="border border-border rounded-xl bg-card p-6 shadow-sm">
            ...
            <p className="text-xs text-muted-foreground text-center mb-6">
              {mode === "login" ? "Accédez à votre base d'actifs" : mode === "signup" ? "Commencez à enrichir vos données" : "Recevez un lien de réinitialisation"}
            </p>
            ...
            <div className="mt-4 text-center space-y-1">
              ...
              {mode === "signup" && (
                <p className="text-xs text-muted-foreground">
                  Déjà un compte ?{" "}
                  <button onClick={() => setMode("login")} className="text-primary hover:underline">Se connecter</button>
                </p>
              )}
              {mode === "forgot" && (
